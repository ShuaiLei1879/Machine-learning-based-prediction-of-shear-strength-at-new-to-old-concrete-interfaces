...
X_train_original, X_test_original, y_train_original, y_test_original = train_test_split(
    X_original, y_original, test_size=0.3, random_state=10
)
...
# 定义参数网格
param_grid = {
    'n_estimators': [0, 10, 20, 40, 60, 80, 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000],
...
try:
    grid_search.fit(X_train_scaled, y_train_original)
...
test_df['True'] = y_test_original.values
...
# 导出到 CSV 文件
output_path = 'E:/Python_study/ProjectOutputs/grid_search_test_scores.csv'
